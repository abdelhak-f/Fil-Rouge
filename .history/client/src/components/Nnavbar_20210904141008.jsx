...
function Navbar() { 
 ...
 <ReactBootstrap.Navbar.Brand className="mx-3" href="#home">Garage El Nour</ReactBootstrap.Navbar.Brand>
 <ReactBootstrap.Navbar.Toggle aria-controls="responsive-navbar-nav" />
 <ReactBootstrap.Navbar.Collapse id="responsive-navbar-nav">
   <ReactBootstrap.Nav className="me-auto">
     <ReactBootstrap.Nav.Link className="mx-5" href="#features">Our Client</ReactBootstrap.Nav.Link>
     <ReactBootstrap.Nav.Link  className="px-5" href="#pricing">Blog</ReactBootstrap.Nav.Link>
